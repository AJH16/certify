            ...
            get
            {
                return new ProviderDefinition
                {
                    ...
                    ProviderParameters = new List<ProviderParameter>{
                        new ProviderStringParameter{ Key="accesskey",Name="Access Key", IsRequired=true},
                        new ProviderPasswordParameter{ Key="secretaccesskey",Name="Secret Access Key", IsRequired=true},
